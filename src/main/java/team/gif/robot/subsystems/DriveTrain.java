...
public class DriveTrain extends SubsystemBase {
    ...
    public static CANSparkMax motor_L = new CANSparkMax(RobotMap.SPARK_MAX_ID, CANSparkLowLevel.MotorType.kBrushless);
    public static SparkPIDController pidController_L = motor_L.getPIDController();
    private static DifferentialDrive drive;
    boolean isRunning = false;
    public DriveTrain(){
        drive = new DifferentialDrive(motor_L,motor_L);
